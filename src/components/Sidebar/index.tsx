...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  useEffect(() => {
    ...
    if (storedPermissions) {
      ...
      const parsedPermissions = storedPermissions.split(',');
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* Category */}
              {permissions.includes('category_items_management') && (
                <SidebarLinkGroup
                  activeCondition={
              ...
              {permissions.includes('category_items_management') && (
                <SidebarLinkGroup
                  activeCondition={
                    pathname === '/' || pathname.includes('cardcategory')
                  }
                >
                  {(handleClick, open) => {
                    return (
              ...
              {/* card Category */}
                ...
                <SidebarLinkGroup
                  activeCondition={
                    pathname === '/' || pathname.includes('cardsubcategory')
                  }
                >
                  {(handleClick, open) => {
                    return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('cards')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('colors')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('storages')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        {translations[language].storages}
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                            }`}
                          width="20"
              ...
              {/* storages */}
              {/* customers */}
              {permissions.includes('customers_management') && (
                <SidebarLinkGroup
                  activeCondition={
              ...
              {permissions.includes('orders_management') && (
                <SidebarLinkGroup
                  activeCondition={
                    pathname === '/' || pathname.includes('orders')
                  }
                >
                  {(handleClick, open) => {
                    return (
              ...
              {permissions.includes('orders_management') && (
                <SidebarLinkGroup
                  activeCondition={
                    pathname === '/' || pathname.includes('cardorder')
                  }
                >
                  {(handleClick, open) => {
                    return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('payments')
                }
              >
                {(handleClick, open) => {
                  return (
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            ...
                            >
                              {translations[language].addpayments}
                            </NavLink>
                          </li>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('communication')
                }
              >
                {(handleClick, open) => {
                  return (
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            ...
                            >
                              {translations[language].AllLinks}
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
              ...
              {/* Notification */}
              {permissions.includes('notification_management') && (
                <SidebarLinkGroup
                  activeCondition={
                    pathname === '/' || pathname.includes('notification')
                  }
                >
                  {(handleClick, open) => {
                    return (
                        ...
                        >
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            <li>
                              ...
                              >
                                {translations[language].addnotification}
                              </NavLink>
                            </li>
                          </ul>
                        </div>
              ...
              {/* admin */}
              {permissions.includes('super_admin_management') && (
                <SidebarLinkGroup
                  activeCondition={
                    pathname === '/' || pathname.includes('admins')
                  }
                >
                  {(handleClick, open) => {
                    return (
              ...
              {/* Settings */}
              {permissions.includes('setting_management') && (
                <SidebarLinkGroup
                  activeCondition={
