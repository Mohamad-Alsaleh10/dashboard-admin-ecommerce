...
export default function ShowAdminPerm() {
    ...
    useEffect(() => {
        ...
        const apiUrl = `https://api.alorfi-store.com/superAdmin_api/show_admin_permissions?adminId=${adminId}`; 
            ...
            {responseData && <div>
                <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                    <div className="max-w-full overflow-x-auto">
                                    ...
                                    <tr key={key}>
                                        <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                            <input
                                                ...
                                                checked={true} // Ensure checkbox state reflects selectedPermissions
                                            />
                                            {packageItem.name}
                                        </td>
                                    </tr>
                        ...
                        <button type="submit" className="inline-flex items-center justify-center rounded-md bg-black py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10">
                        <Link to={`/editadminpermission/${adminId}`}>
                         Edit permissions
                        </Link>
                        </button>
                    </div>
