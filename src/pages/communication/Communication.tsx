...
export default function Communication() {
  ...
  const handledelete = async (categoryId) => {
    try {
      ...
      const response = await axios.delete(`https://api.alorfi-store.com/superAdmin_api/delete_app?appId=${categoryId}`, {
        headers: headers
      });
                ...
                <tr key={key}>
                  ...
                  <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                    <div className="h-12.5 w-15 rounded-md">
                      <img src={`https://api.alorfi-store.com/storage/${packageItem.icon}`} alt="Brand" />
                    </div>
                  </td>
